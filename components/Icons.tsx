...
export const VolleyballIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.03v.568c0 .334.148.65.405.864l1.068.89c.442.369.535 1.01.216 1.49l-.51.766a2.25 2.25 0 0 1-1.161.886l-.143.048a1.107 1.107 0 0 0-.57 1.664l.369.555a1.125 1.125 0 0 1 .168 1.123l-.654 1.207a1.125 1.125 0 0 1-1.646.566l-.182-.098a2.25 2.25 0 0 1-1.207-.638l-.51-.766a2.25 2.25 0 0 0-3.426-.21l-3.18.981a2.25 2.25 0 0 0-1.664 2.19l.213 1.585a2.25 2.25 0 0 0 2.17 2.043l1.584.214a2.25 2.25 0 0 0 2.19-1.664l.98-3.18a2.25 2.25 0 0 0-.21-3.426l-.766-.51a2.25 2.25 0 0 1-.638-1.207l-.098-.182a1.125 1.125 0 0 1 .566-1.646l1.207-.654a1.125 1.125 0 0 1 1.123.168l.555.369a1.107 1.107 0 0 0 1.664-.57l.048-.143a2.25 2.25 0 0 1 .886-1.161l.766-.51a2.25 2.25 0 0 0 1.49-.216l.89-1.068a1.125 1.125 0 0 0 .864-.405v-.568a12 12 0 1 0-9.873 17.653" />
  </svg>
);
...
export const TrophyIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 0 1-4.874-1.971 2.25 2.25 0 0 1-1.342-2.822l3.42-8.55a2.25 2.25 0 0 1 2.16-1.597h3.332a2.25 2.25 0 0 1 2.16 1.597l3.42 8.55a2.25 2.25 0 0 1-1.342 2.822A9.75 9.75 0 0 1 16.5 18.75Z M9 12.75h6" />
    </svg>
);
